    ...
    <AnimatePresence>
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 w-full h-screen bg-[#0033A0] z-[100000] flex items-center justify-center"
        >
          {/* Logo Container */}
          <motion.div 
          ...
          >
            ...
            <div className="text-blue-950/40">
              Mohankumar<span className="text-blue-950/40"></span>
            </div>
            ...
            >
              Mohankumar<span className="text-cyan-400"></span>
            </motion.div>
          </motion.div>
